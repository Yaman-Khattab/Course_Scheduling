...
class CsCourses(models.Model):
    courseid = models.AutoField(db_column='CourseID')  # Field name made lowercase.
...
class College(models.Model):
    collegeid = models.AutoField(db_column='CollegeID')  # Field name made lowercase.
...
class Student(models.Model):
    stdid = models.AutoField(db_column='StdID')  # Field name made lowercase.
